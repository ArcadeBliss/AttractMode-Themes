			...
			animation.add( PropertyAnimation( frameg, 
				{   
					...
					tween = Tween.Linear, 
						...
						x = (width * sel_x + ((fe.layout.width - (fe.layout.width / 1.105448275)) / 2) + 22) 
						y = ((fe.layout.height / 1.51 + height * sel_y) + 195)
					}, 
					time = transition_ms 
				} ) );
...
// Frame 1 Yellow
gridc.frame=fe.add_image( "assets/uielements/frame.png", width * 2, height * 2, 295, 80 );

// Frame 1 whiteglow
gridc.frameg=fe.add_image( "assets/uielements/frameglow.png", width * 2, height * 2, 295, 80 );
...
// add the video
gridc.video_t = fe.add_artwork( "Video", 0, fe.layout.height / 20, fe.layout.width, fe.layout.height * 0.795);
